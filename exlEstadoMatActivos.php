<?php
	...
	else
	{
		...
		header('Content-Disposition: attachment; filename=EstadoMatActivos' . date("YmdHis") . '.xls');
        ...
        echo('<th align="center" style="color:rgb(255,255,255); background-color:rgb(0,100,255);">Activo</th>');
